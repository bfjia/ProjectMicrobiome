...
#python2 -m pip install rpy2==2.8.6, requires R3.5 (https://www.r-bloggers.com/updating-r-on-ubuntu/), python2.7-dev from apt-get, coin, mvtnorm,modeltools from CRAN
